# results/generated/text_exp/quest8
2026-04-12 21:43:20
...
```
Для добычи ресурса 'Уголь' нужен инструмент 'кирка' ранга не ниже 1, но у игрока лучший доступный ранг равен 0
```
...
```
Персонаж 'Мастер Ювелир' не может выдать предмет 'Каменный меч' в качестве награды
```
