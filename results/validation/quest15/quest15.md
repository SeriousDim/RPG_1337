# results/generated/text_exp/quest15
2026-04-12 21:43:20
...
```
Для добычи ресурса 'Подорожник' нужен инструмент 'лопата' ранга не ниже 1, но у игрока лучший доступный ранг равен 0
```
...
```
Персонаж 'Гаррик Кузнец' не принимает ресурс 'Подорожник' в качестве награды или добычи
```
...
```
Персонаж 'Гаррик Кузнец' не может выдать предмет 'Каменный меч' в качестве награды
```
